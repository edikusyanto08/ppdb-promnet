      ...
      <div class="fl_left">
        ...
        <div id="hpage_gallery">
          <ul class="clear">
            ...
            <li class="last"><a href="#"><img src="<?php echo base_url('assets/landingpage/'); ?>images/demo/175x130.gif" alt="" /></a></li>
            <li><a href="#"><img src="<?php echo base_url('assets/landingpage/'); ?>images/demo/175x130.gif" alt="" /></a></li>
            <li class="last"><a href="#"><img src="<?php echo base_url('assets/landingpage/'); ?>images/demo/175x130.gif" alt="" /></a></li>
          </ul>
        </div>
        ...
        <div id="hpage_socialize">
          ...
          <form action="#" method="post">
            <fieldset>
              ...
              <input type="image" id="subscribe" src="<?php echo base_url('assets/landingpage/'); ?>layout/images/sign-up.gif" alt="Submit" />
            </fieldset>
          </form>
        ...
        <div id="hpage_specials" class="clear">
          <ul>
            <li>
              ...
              <div class="box">
                <div class="imgholder"><img src="<?php echo base_url('assets/landingpage/'); ?>images/demo/160x160.gif" alt="" /></div>
