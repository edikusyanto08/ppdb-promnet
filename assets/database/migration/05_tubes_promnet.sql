...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2017 at 02:11 AM
...
(155, 1, 'siswa', 'Logged Out', '2017-01-04 06:12:37'),
(156, 1, 'siswa', 'Logged In', '2017-01-04 06:13:58'),
(157, 1, 'siswa', 'Logged In', '2017-01-04 17:00:58'),
(158, 1, 'siswa', 'Logged Out', '2017-01-04 17:46:59'),
(159, 1, 'siswa', 'Logged In', '2017-01-04 17:47:05'),
(160, 1, 'siswa', 'Logged Out', '2017-01-04 18:16:49'),
(161, 1, 'sekolah', 'Logged In', '2017-01-04 18:17:04');
...
INSERT INTO `penerimaan` (`ID_penerimaan`, `ID_siswa`, `ID_jurusan`) VALUES
(6, 1, 2);
...
(10, 1, 'Ijazah1.PNG', 'skhun1.PNG', 'KK1.pdf', 'SKKB1.PNG', 'rapor1.PNG', 'foto1.png'),
...
(1, '123456', 'Ronaldo Simanjuntak', '4haZynwsf', 'b104ab9a0e58c861b9628208b3fecd58', 'Laki-laki', '2000-01-08', 'simanjuntakronaldo9@gmail.com', '08567934299', 1, 4, 1),
(2, '123457', 'John Doe', 'a7QkFodd9V', '81dc9bdb52d04dc20036dbd8313ed055', NULL, NULL, 'jondower@gmail.com', '0215503733', 1, 1, 1),
(3, '123458', 'Alan Walker', 'ZI9gjgv3Sh', '81dc9bdb52d04dc20036dbd8313ed055', NULL, NULL, 'walker@gmail.com', '0812332122', 1, 1, 1),
...
(7, '0003', 'I Gede Tidituna', '2GigJSVKPG', '81dc9bdb52d04dc20036dbd8313ed055', NULL, NULL, 'igedetid@gmail.com', '+6289933229933', 4, 1, 1),
(8, '1304491', 'Aulia Fahmi', 'giLaXXOeXi', '81dc9bdb52d04dc20036dbd8313ed055', NULL, NULL, 'aulia@gmail.com', '085345678912', 5, 1, 1),
...
CREATE TABLE `tetapan` (
  `ID_tetapan` int(11) NOT NULL,
  `nama_tetapan` varchar(50) NOT NULL,
  `isi_tetapan` varchar(150) DEFAULT NULL,
  `status` int(11) DEFAULT '1'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `tetapan` (`ID_tetapan`, `nama_tetapan`, `isi_tetapan`, `status`) VALUES
(1, 'tanggal_pendaftaran', '2017-01-04', 1),
(2, 'tanggal_pengumuman', '2017-01-14', 1);
...
--
ALTER TABLE `tetapan`
  MODIFY `ID_tetapan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
